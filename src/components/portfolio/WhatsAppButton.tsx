        ...
        >
          ...
          <AnimatePresence>
            {showTooltip && (
              ...
              >
                <div className="glass-card rounded-xl p-4 relative border border-white/10">
                  <button
                  ...
                  <p className="text-sm text-white font-medium mb-1">Let's Chat! 💬</p>
                  <p className="text-xs text-white/50">
                    Quick responses on WhatsApp
                  </p>
                  <div className="absolute -bottom-2 right-6 w-4 h-4 glass-card rotate-45 border-b-0 border-r-0" />
                </div>
              </motion.div>
            )}
          </AnimatePresence>
